...
Only Difference is 
Mode is set to 1 for all BatchNormalization Layers
'''
...
def identity_block(input_tensor, kernel_size, filters, stage, block):
    ...
    x = BatchNormalization(mode=1,axis=bn_axis, name=bn_name_base + '2a')(x)
    x = Activation('relu')(x)

    x = Convolution2D(nb_filter2, kernel_size, kernel_size,
                      border_mode='same', name=conv_name_base + '2b')(x)
    x = BatchNormalization(mode=1,axis=bn_axis, name=bn_name_base + '2b')(x)
    x = Activation('relu')(x)

    x = Convolution2D(nb_filter3, 1, 1, name=conv_name_base + '2c')(x)
    x = BatchNormalization(mode=1,axis=bn_axis, name=bn_name_base + '2c')(x)
...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2, 2)):
    ...
    shortcut = BatchNormalization(mode=1,axis=bn_axis, name=bn_name_base + '1')(shortcut)
...
def ResNet50(include_top=True, weights='imagenet',
    ...
    x = BatchNormalization(mode=1,axis=bn_axis, name='bn_conv1')(x)
    x = Activation('relu')(x)
